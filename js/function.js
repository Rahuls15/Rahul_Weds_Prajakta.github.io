...
$(document).on('ready', function () {
    ...
    $('.other-menu').on('mouseenter', function () {
     ...
     // JavaScript Document
   var today = new Date();
   var target = new Date('07/08/2018 13:30:00'); //Enter Target date & time - MM/DD/YYYY hh:mm:ss
   var startdate = new Date('06/22/2018'); //Enter Timer start date or Today's date - MM/DD/YYYY
   ...
   if ($.find('#example').length) {
       $('#example').countdown({
           date: '07/08/2018 13:30:00', //Enter Target date & time - MM/DD/YYYY hh:mm:ss
           offset: +5.5,
           day: 'Day',
           days: 'Days'
       }, function () {
